...
FONT_FILE_BITMAP = "./gifos/fonts/gohufont-uni-14.pil"   # terminal utama
...
def render_intro():
    ...
    time_now = datetime.now().strftime("%a %b %d %H:%M:%S %Y")
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("kristiantobudi", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("kristiantobudi", ignore_repos)
    user_age = gifos.utils.calc_age(26, 7, 2002)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mkristiantobudi@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mArch/Gentoo Linux, Windows 11, Android 14\x1b[0m
    \x1b[96mHost:   \x1b[93mWindows 11\x1b[0m
    \x1b[96mKernel: \x1b[93mTechnik Networking & Computer \x1b[94m#CSE\x1b[0m
    ...
    --------------
    \x1b[96mEmail:      \x1b[kristiantobudipurwoko@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[kristianto-budi-purwoko\x1b[0m
    ...
    t.gen_typing_text(" -u kristiantobudi", 1, contin=True)
...
<sub><i>Generated automatically using [kristiantobudi/kristiantobudi](https://github.com/kristiantobudi/kristiantobudi) on {time_now}</i></sub>
